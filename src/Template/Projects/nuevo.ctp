    ...
    <div id="page-content-wrapper">
        ...
        <div class="panel">
            ...
            <br>  
                ...
                <div class="form-group">
                        <div class="col-sm-1"></div>
                        <label class="col-sm-1 control-label">Instrucciones</label>
                        <div class="col-sm-6">
                            Clima Organizacional
                            <textarea name="" rows="3" class="form-control textarea-no-resize"></textarea>
                        </div>
                ...
                <div class="form-group">
                            ...
                            Desde
                                <div class="input-prepend input-group">
                                    ...
                                    <input type="text" class="bootstrap-datepicker form-control" value="dd/mm/aa" data-date-format="dd/mm/yy">
                                </div>
                            </div>
                            <div class="col-sm-2">
                            Hasta
            ...
            <div class="col-sm-3"><button class="btn btn-purple"><i class="glyph-icon icon-save"></i> Guardar</button></div>
            <br>
